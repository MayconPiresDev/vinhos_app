                    ...
                    {pedidosFakes.map((pedido) => (
                        <TableRow key={pedido.id}>
                            ...
                            <TableCell className="flex items-center gap-2 text-muted-foreground">
                                {pedido.etapa === "Entregue" && <PackageCheck className="w-4 h-4 text-green-600" />}
                                {pedido.etapa === "Enviado" && <Truck className="w-4 h-4 text-blue-600" />}
                                {pedido.etapa === "Processando" && <Clock className="w-4 h-4 text-yellow-500" />}
                                <span>{pedido.etapa}</span>
                            </TableCell>
                            <TableCell className="text-muted-foreground">{pedido.entregaPrevista}</TableCell>
